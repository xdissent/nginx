...
default['nginx']['owner'] = "root"
default['nginx']['owner_group'] = "root"
default['nginx']['script_prefix'] = "/usr/sbin"
...
if platform_family? "mac_os_x"
  ...
  default['nginx']['owner'] = ::ENV["USER"]
  default['nginx']['owner_group'] = "admin"
  default['nginx']['script_prefix'] = "/usr/local/sbin"
  default['nginx']['user'] = ::ENV["USER"]
  default['nginx']['group'] = "staff"
  default['nginx']['pid'] = "/usr/local/var/run/nginx.pid"
end
